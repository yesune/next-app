...
const VotingModal = ({ choice, labelText, setChoice, choicesArray }:
   { choice: string,
     labelText: string,
  ...
  return (
    ...
    <div className="modal-box w-full h-full">
        ...
        <div className="radio-container">
            ...
            <div className="radio-row flex flex-row">
                <div className="w-1/2">
                <RadioImg choice={choice} labelText={choicesArray[6]} setChoice={setChoice} />
                </div>
                <div className="w-1/2">
                <RadioImg choice={choice} labelText={choicesArray[7]} setChoice={setChoice} />
                </div>
            </div>
            <div className="radio-row flex flex-row">
                <div className="w-1/2">
                <RadioImg choice={choice} labelText={choicesArray[8]} setChoice={setChoice} />
                </div>
                <div className="w-1/2">
                <RadioImg choice={choice} labelText={choicesArray[9]} setChoice={setChoice} />
                </div>
            </div>
            <div className="radio-row flex flex-row">
                <div className="w-1/2">
                <RadioImg choice={choice} labelText={choicesArray[10]} setChoice={setChoice} />
                </div>
                <div className="w-1/2">
                <RadioImg choice={choice} labelText={choicesArray[11]} setChoice={setChoice} />
                </div>
            </div>
            <div className="radio-row flex flex-row">
                <div className="w-1/2">
                <RadioImg choice={choice} labelText={choicesArray[12]} setChoice={setChoice} />
                </div>
            </div>
        </div>
    </div>
